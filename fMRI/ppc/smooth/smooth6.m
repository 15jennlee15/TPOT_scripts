...
matlabbatch{3}.spm.util.exp_frames.files(1) = cfg_dep(cfg_dep('File Selector (Batch Mode): Selected Files (sub-TPOT002_ses-1_task-affect_acq-1_run-.*-space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{3}.spm.util.exp_frames.frames = Inf;
matlabbatch{4}.spm.util.exp_frames.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (sub-TPOT002_ses-1_task-affect_acq-2_run-.*-space-MNI152NLin2009cAsym_desc-preproc_bold.nii.gz)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{5}.spm.spatial.smooth.prefix = 's6_';
